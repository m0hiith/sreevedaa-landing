      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '1.5rem' }} className="special-grid">
        ...
        <div className="special-card" style={{ borderRadius: '1.5rem', overflow: 'hidden', border: '1px solid rgba(45,75,59,0.1)', transition: 'all 0.3s' }}>
          ...
          <div style={{ padding: '2rem' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: '#6b7068', lineHeight: 1.6 }}>Experience Kerala&apos;s 5,000-year-old healing tradition. Our Panchakarma detox and Shirodhara oil therapy deeply rejuvenate mind, body and soul — administered by trained Ayurvedic professionals.</p>
          </div>
        </div>
